...
\usepackage{caption}
\captionsetup{format= hang,labelsep=endash,labelfont=bf} 
...
%\includepdf{ficha_corrigida.pdf}
...
\chapter{Cronograma de desenvolvimento do projeto}
